...
if (!isset($_GET['id'])) {
    ...
    $redirectPage = ($role === 'superadmin') ? 'data_khusus_tampil' : 'profil_perusahaan';
...
if (!$data) {
    echo "<script>alert('Data tidak ditemukan!'); window.location.href='?page=data_khusus_tampil';</script>";
    exit();
}

// Eksekusi penghapusan
$sqlDelete = "DELETE FROM data_khusus WHERE id = ?";
