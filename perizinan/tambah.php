            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-2">
                    ...
                    <select name="jenis_laporan" id="jenis_laporan" class="form-control" required>
                        ...
                        <option value="NIIS">NIIS</option>
                        <option value="NPWP">NPWP</option>
                        <option value="PERIZINAN BERUSAHA SEKTOR INDUSTRI">PERIZINAN BERUSAHA SEKTOR INDUSTRI</option>
                        ...
                        <option value="PELAPORAN S1 S2 SINAS">PELAPORAN S1 S2 SINAS</option>
                        <option value="KEPEMILIKAN AKUN SINAS">KEPEMILIKAN AKUN SINAS</option>
                        <option value="KESESUAIAN KEGIATAN USAHA">KESESUAIAN KEGIATAN USAHA</option>
                        <option value="KESESUAIAN FASILITAS">KESESUAIAN FASILITAS</option>
